...
GRANT INSERT ON TABLE ATTENDANCE TO 'Sign-in'@'localhost';
GRANT SELECT, INSERT ON TABLE TESTING_SIGN_UP TO 'Sign-in'@'localhost';
...
GRANT SELECT ON TABLE STAFF_PERMISSIONS TO 'ViewNext'@'localhost';
GRANT SELECT ON TABLE ACCOUNT_LOCKS TO 'ViewNext'@'localhost';
GRANT SELECT ON TABLE LOGIN_LOG TO 'ViewNext'@'localhost';
GRANT SELECT ON TABLE MEMBER TO 'ViewNext'@'localhost';
############################grant login priviledges#################3
GRANT SELECT, UPDATE, INSERT ON SQUADRON_MANAGER.* TO 'login'@'localhost';
GRANT DELETE, select ON SQUADRON_MANAGER.* TO 'delete'@'localhost';
GRANT SELECT ON SQUADRON_MANAGER.* TO 'notif'@'localhost';
#Give useless barely enough
GRANT USAGE ON *.* TO 'Useless'@'localhost';